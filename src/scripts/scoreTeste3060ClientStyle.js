...
Pergunta do intervalo das mamadas deve vir explicada. Sem Travesseiro. Sem hipótese noturna inventada.`,
    criteria: [
      ...
      { id: 'no_feed_to_relax', w: 10, pass: (t) => !/caprichar nas mamadas.{0,40}relaxar|oferecer o peito pode ajudar a relax|facilitar a transi[cç][aã]o para o sono/i.test(t) },
