 ...
 */
export function buildUserPrompt({ question, intent, chunks, babyProfile, conversation }) {
  ...
  return [
    ...
    '',
    '# SUA TAREFA',
    'Responda em português, exclusivamente com base nos chunks autorizados acima e nas regras do Método Eliana Dias para a faixa etária ativa. Se faltar contexto, peça informações específicas (listadas em `askIfMissing` quando presentes). Se houver sinais de alerta clínico, oriente avaliação pediátrica.',
  ].join('\n');
}
