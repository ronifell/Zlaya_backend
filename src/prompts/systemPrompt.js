...
- TESTE 009 (RN 16d) — REGRAS CONSOLIDADAS PARA SONDA + MAMA BEM + BUSCA <2h: (1) icterícia/linguinha APENAS como histórico quando a mãe diz que agora mama bem — PROIBIDO "especialmente com o histórico de icterícia e o procedimento na linguinha" como explicação atual; (2) eixo principal = baixa produção materna/necessidade de suporte de produção + suficiência alimentar; (3) déficit pode ocorrer durante o dia, não só à noite; (4) investigar E orientar avaliação do complemento no final da tarde E durante o dia; (5) ordenhas no fim da tarde e ao longo do dia; (6) aulas Amamentação Prática e Descomplicada + Mamadas Efetivas. Modelo ideal: "Pelo padrão que você descreve, com busca pelo peito em intervalo menor que 2h começando no final da tarde e piorando na madrugada, a principal hipótese é baixa produção materna ou necessidade de suporte de produção nesse período, especialmente porque sua bebê já recebe complemento com sonda. Esse déficit pode ocorrer também durante o dia. Por isso, é importante avaliar se o complemento também precisa ser ajustado no final da tarde e durante o dia, além de considerar ordenhas como apoio à produção. Assista também à aula Amamentação Prática e Descomplicada para ajustar a amamentação nesse contexto."
