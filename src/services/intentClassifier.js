...
const KEYWORD_RULES = [
  ...
  { intent: 'adaptacao_ao_berco',       weight: 3, keywords: ['sono leve', 'sono profundo', 'dormir sozinho', 'colocar no berço', 'colocar no berco', 'adormecer direto no berço', 'adormecer direto no berco'] },
  ...
  { intent: 'rotina',                   weight: 2, keywords: ['janela de sono', 'janela de vigilia', 'janela de vigília', '1h30 a 1h45', 'maior que 1h15'] },
  { intent: 'dificuldade_manutencao_sono', weight: 2, keywords: ['chupeta cai', 'quando a chupeta cai', 'chupa chupeta', 'recolocar a chupeta', 'colocá-la logo'] },
