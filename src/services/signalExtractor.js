...
const SIGNAL_DEFS = [
  ...
  },
  {
    ...
    priority:
      'PADRÃO CRÍTICO TESTE 008 (RN 16d): a mãe relata que a bebê AGORA está mamando bem E há complemento com sonda. A hipótese principal a NOMEAR EXPLICITAMENTE é BAIXA PRODUÇÃO MATERNA OU NECESSIDADE DE SUPORTE DE PRODUÇÃO — NÃO "baixa transferência". É PROIBIDO citar icterícia ou linguinha como causa ATUAL do comportamento — trate apenas como histórico. NÃO normalize como "fisiológico e esperado" ou "bastante comum" com complemento com sonda + busca pelo peito em intervalo <2h. Modelo aceito: "Como sua bebê já recebe complemento com sonda, isso indica baixa produção materna ou necessidade de suporte de produção. Mesmo que ela esteja mamando bem agora, esse déficit pode ocorrer também durante o dia e gerar maior instabilidade no fim da tarde e na madrugada." PERGUNTA OBRIGATÓRIA: o complemento foi orientado só para a noite ou também para o final da tarde e durante o dia? Incluir ORDENHAS, segundo peito quando necessário, avaliar complemento também durante o dia. AULAS: Amamentação Prática e Descomplicada + Mamadas Efetivas.',
  },
  {
