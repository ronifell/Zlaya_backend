...
const SIGNAL_DEFS = [
  ...
  },
  {
    ...
    priority:
      'PADRÃO CRÍTICO TESTE 009 (RN 16d): a mãe relata que a bebê AGORA está mamando bem E há complemento com sonda + busca pelo peito em intervalo <2h (especialmente fim da tarde/madrugada). A hipótese principal a NOMEAR EXPLICITAMENTE é BAIXA PRODUÇÃO MATERNA OU NECESSIDADE DE SUPORTE DE PRODUÇÃO — NÃO "baixa transferência". É PROIBIDO citar icterícia ou linguinha como causa ATUAL ou contexto explicativo — trate apenas como histórico; PROIBIDO "especialmente com o histórico de icterícia e o procedimento na linguinha". NÃO normalize como "fisiológico e esperado", "bastante comum" ou "muitos comportamentos são fisiológicos e esperados". Modelo aceito: "Pelo padrão que você descreve, com busca pelo peito em intervalo menor que 2h começando no final da tarde e piorando na madrugada, a principal hipótese é baixa produção materna ou necessidade de suporte de produção nesse período, especialmente porque sua bebê já recebe complemento com sonda. Esse déficit pode ocorrer também durante o dia. Por isso, é importante avaliar se o complemento também precisa ser ajustado no final da tarde e durante o dia, além de considerar ordenhas como apoio à produção." PERGUNTAS OBRIGATÓRIAS: o complemento foi orientado só para a noite ou também para o final da tarde e durante o dia? Durante o dia ela também busca o peito em menos de 2h? Incluir ORDENHAS no fim da tarde e ao longo do dia, segundo peito quando necessário, posição vertical 30 a 40 min. GÊNERO: manter feminino se a mãe usa ela/minha bebê — nunca "ele continua" ou "se ele mama". AULAS: Amamentação Prática e Descomplicada + Mamadas Efetivas.',
  },
  {
