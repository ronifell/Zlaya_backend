...
const SIGNAL_DEFS_30_60 = [
  ...
  },
  {
    ...
    priority:
      'Preserve o relógio: “após as 4h da manhã” NÃO é “após 4 horas de sono”. A PRIMEIRA orientação prática é identificar o horário da última mamada — NÃO comece dizendo para tentar fazê-lo dormir sem oferecer o peito. Fluxo: (1) horário da última mamada antes das 4h; (2) se já transcorreram ~2h30–3h desde mamada efetiva, mamada efetiva até a saciedade; se ainda não completou esse intervalo após mamada efetiva, tentar conduzir ao sono sem oferecer o peito imediatamente; (3) rotina alimentar do DIA (intervalos, efetividade, manutenção da saciedade, produção); (4) medidas posturais pós-mamada (arroto, vertical 20–30 min) e desconforto. NÃO indique aula de “Despertar Irritado Pós-Soneca”: o caso é despertares noturnos. Indique Estratégias para o Sono Noturno. NÃO contradiga: se já transcorreram ~2h30–3h, NÃO oriente em seguida a conduzir sem peito. O intervalo de 3h NÃO decide sozinho, isolado desses dados, que a mamada é desnecessária. NÃO use intervalo fixo de 3h para evitar mamada sem essa avaliação. NÃO diga "não é necessário acordá-lo" se a mãe NÃO está acordando o bebê. NÃO diga que investigar alimentação ajuda a evitar associação despertar–mamada. NÃO use “associações negativas entre acordar e mamar”. NÃO comece por associação peito–sono. A percepção de que "não é fome" NÃO basta — oferecer o peito não se resume a ele ser novinho. NÃO entregue frases truncadas (ex.: "Isso pode ajudar a" ou "Isso é importante para" sem conclusão).',
  },
];
