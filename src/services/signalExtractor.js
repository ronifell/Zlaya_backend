...
const SIGNAL_DEFS = [
  ...
  },
  {
    ...
    priority:
      'A mãe JÁ TENTOU a Estratégia do Travesseiro e NÃO teve sucesso. NÃO cite a estratégia de forma genérica — CORRIJA a aplicação e NUNCA perca o eixo alimentar. (1) ASSISTIR/REASSISTIR à aula e repetir EXATAMENTE como ensinado. (2) ETAPA INTERMEDIÁRIA: travesseiro EM CIMA DO COLO com CONTENÇÃO das mãos — PARTE DO PROCESSO, NÃO FALHA. (3) Investigue mamada efetiva, saciedade, produção (especialmente fim da tarde), arroto, posição vertical 30 a 40 min. (4) Charutinho se Moro/desorganização — diga TEXTUALMENTE na resposta. (5) Ambiente escuro, calmo, baixa estimulação. Leitura FISIOLÓGICA: adaptação fisiológica, organização corporal, transição de superfície/textura — NÃO "acostumado ao colo". Reassegure: com [N] dias AINDA NÃO CRIA associação negativa. AULAS: Travesseiro, Berço, Estimule o Arroto, Mamadas Efetivas, Charutinho (se Moro). NÃO indicar Início do Sono Noturno nem Troca dia/noite.',
  },
  {
  ...
  },
  {
    ...
    priority:
      'PADRÃO CRÍTICO TESTE 005 (RN 16d): a mãe relata que a bebê AGORA está mamando bem E há complemento com sonda. A hipótese principal a NOMEAR EXPLICITAMENTE é BAIXA PRODUÇÃO MATERNA OU NECESSIDADE DE SUPORTE DE PRODUÇÃO — NÃO "baixa transferência". É PROIBIDO citar icterícia ou linguinha como causa ATUAL do comportamento — trate apenas como histórico. NÃO normalize como "bastante comum" com complemento com sonda + busca pelo peito em intervalo <2h. Modelo aceito: "Como sua bebê já recebe complemento com sonda, isso indica baixa produção materna ou necessidade de suporte de produção. Mesmo que ela esteja mamando bem agora, esse déficit pode ocorrer também durante o dia e gerar maior instabilidade no fim da tarde e na madrugada." Incluir ORDENHAS, avaliar complemento também durante o dia e no final da tarde. AULA: Mamadas Efetivas / Amamentação Prática e Descomplicada.',
  },
  {
    ...
    priority:
      'PADRÃO CRÍTICO TESTE 004/007 (RN 20d): bebê é colocado no berço, permanece poucos minutos (~20 min), acorda chorando e SÓ MELHORA quando volta ao colo, com NOITE PRESERVADA. ABERTURA: "Sonecas curtas podem acontecer no RN, mas acordar chorando após cerca de 20 minutos no berço e melhorar apenas no colo não deve ser tratado como simplesmente esperado — merece investigação." AULAS: Estimule o Arroto, O que é o Refluxo, Travesseiro (secundário), Charutinho/Moro, Mamadas Efetivas. NÃO indicar Troca dia-noite / Início do Sono Noturno. Investigue: mamada efetiva/saciedade, desconforto pós-mamada/refluxo fisiológico, possibilidade de refluxo patológico (sinais clínicos), Moro/charutinho. OBRIGATÓRIO: posição vertical 30 a 40 min. Refluxo fisiológico → elevação 30 a 40°; refluxo patológico/suspeita → elevação 45° + Pediatra Roberto Franklin + suporte humano (quando houver sinais clínicos).',
  },
];
